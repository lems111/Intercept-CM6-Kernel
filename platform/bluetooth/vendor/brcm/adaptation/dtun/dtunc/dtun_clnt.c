...
static const char *id_name[] =
{
    ...
    /* AV signals */
    "DTUN_SIGNAL_AV_BEGIN",
    "DTUN_SIG_AM_AV_EVENT",
    "DTUN_SIGNAL_AV_END",

    /* OBEX methods */
    "DTUN_METHOD_OBEX_BEGIN",
...
{
    if ((id>DTUN_METHOD_DM_BEGIN) && (id<DTUN_SIG_DM_END))
        return DTUN_INTERFACE_DM;
    else  if ((id>DTUN_METHOD_AV_BEGIN) && (id<DTUN_SIG_AV_END))
        return DTUN_INTERFACE_AV;
    else if ((id>DTUN_METHOD_OBEX_BEGIN) && (id<DTUN_SIG_OBEX_END))
        return DTUN_INTERFACE_OBEX;    
    else
...
{
    if ((id > DTUN_METHOD_DM_BEGIN) && (id < DTUN_METHOD_DM_END))
        return id - DTUN_METHOD_DM_BEGIN - 1;
    else if ((id > DTUN_SIG_DM_BEGIN) && (id < DTUN_SIG_DM_END))
        return id - DTUN_SIG_DM_BEGIN - 1;
    else if ((id > DTUN_METHOD_AV_BEGIN) && (id < DTUN_METHOD_AV_END))
        return id - DTUN_METHOD_AV_BEGIN - 1;
    else if ((id > DTUN_SIG_AV_BEGIN) && (id < DTUN_SIG_AV_END))
        return id - DTUN_SIG_AV_BEGIN - 1;
    else if ((id > DTUN_METHOD_OBEX_BEGIN) && (id < DTUN_METHOD_OBEX_END))
        return id - DTUN_METHOD_OBEX_BEGIN - 1;
    else if ((id > DTUN_SIG_OBEX_BEGIN) && (id < DTUN_SIG_OBEX_END))
        return id - DTUN_SIG_OBEX_BEGIN - 1;
    else
...
void dtun_start_interface(tDTUN_INTERFACE iface, tDTUN_SIGNAL *tbl, tDTUN_PROCESS_INIT init_cb)
{
    ...
    tSUBSYSTEM sub = iface + SUBSYSTEM_DTUN_DM; // remap to subsystem
...
void dtun_client_test(void)
{
    ...
    dtun_start_interface(DTUN_INTERFACE_DM, test_signal_tbl, NULL);
