...
#define ENABLE_XBL 0
//SAMSUNG CHANGES +
//Comment these two lines and add these compiler flags in Android.jsc.mk or in Android.v8.mk make file
...
//Enable/Disable Samsung specific feature
//#if ENABLE(XSLT) && ENABLE(XPATH)
//#define ENABLE_SEC_FEATURE_RSS      1
//#else
//Disabling RSS rendering infavour of Google Reader
#define ENABLE_SEC_FEATURE_RSS      0
//#endif
