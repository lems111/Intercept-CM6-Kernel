...
#define HARDWARE_MAX_MAC_RESPONSES		20			// maximum wait time on getting MAC address
#define HARDWARE_MAC_REQ_TIMEOUT		(1000 * 1000 * 10)	// 1 second timeout
#define HARDWARE_START_TIMEOUT			500			// 300 ms
...
typedef struct {
	PVOID           		ReceiveBuffer;		// receive data buffer
