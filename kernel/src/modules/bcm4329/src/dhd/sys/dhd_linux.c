...
#if defined(DHD_USE_STATIC_BUF) && defined(CUSTOMER_HW_SAMSUNG)  // namju 10.04.21 (from s1 - do not overwrite)
...
dhd_read_macaddr(dhd_info_t *dhd)
{
    ...
    char* nvfilepath       = "/data/misc/wifi/.nvmac.info";//cyj_dd14
	int rtn_value        = 0;
