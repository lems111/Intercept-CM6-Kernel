...
struct s3c_keypad_extra s3c_keypad_extra[] = {
	{0x0000, NULL,  &special_key_instinctq_01a_40[0], 4,   &gpio_key_instinctq_01[0] , 1, 0},	
};
...
struct s3c_keypad_extra s3c_keypad_extra[] = {
	...
	{0x0050, &slide_instinctq,  &special_key_instinctq_01a_40[0], 4,   &gpio_key_instinctq_01[0] , 1, 0},	
};
#endif
