...
//#include "MTH_SM910_R40_V07_bin.c"
//#include "MTH_SM910_R40_V11_bin.c"
//#include "MTH_SM910_R80_V10_bin.c"
//#include "MTH_SM910_RA0_V13_bin.c" // RA0 and R80 are firmware compatible
//#include "MTH_SM910_RA0_VF4_bin.c" // multi touch
//#include "MTH_SM910_R40_V16_bin.c" // multi touch
//#include "MTH_SM910_RA0_V15_bin.c" // multi touch

//#include "MTH_SM910_R40_V1C_bin.c" // multi touch
//#include "MTH_SM910_R80_V1B_bin.c" // multi touch
//#include "MTH_SM910_RE0_V1A_bin.c" // multi touch

//#include "MTH_SM910_R40_V1F_bin.c" // multi touch
//#include "MTH_SM910_R80_V1E_bin.c" // multi touch
//#include "MTH_SM910_RE0_V1D_bin.c" // multi touch

//#include "MTH_SM910_R40_V23_bin.c" // multi touch
#include "MTH_SM910_R40_V25_bin.c" // multi touch (if updated R80, will be displayed 8F in HW)
//#include "MTH_SM910_R80_V22_bin.c" // multi touch
...
#include "MTH_SI100_R61_V16_bin.c"
#else
...
//    ret = mcsdl_download( MTH_SM900_R63_V15_bin, MTH_SM900_R63_V15_bin_nLength );
...
#endif
    {
		...
		if(pfirmware == NULL)
			...
			printk(KERN_WARNING "[TSP] R%X firmware is selected\n", hw_ver);
#elif defined(CONFIG_MACH_MAX)        
        pfirmware = MTH_SI100_R61_V16_bin;
        firmware_size = MTH_SI100_R61_V16_bin_nLength;
#else
